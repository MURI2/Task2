...
for i in "${SoilGen[@]}"
do
  REF="/N/dc2/projects/muri2/Task2/LTDE/data/2016_KBSGenomes_Annotate/${i}/G-Chr1.fna"
  bwa index $REF
  samtools faidx $REF
done
...
do
  ...
  if [ "$Result" -eq 1 ]; then
    ...
    REF="/N/dc2/projects/muri2/Task2/LTDE/data/2016_KBSGenomes_Annotate/${SPECIES}/G-Chr1.fna"
