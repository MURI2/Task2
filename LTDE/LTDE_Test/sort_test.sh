...
java -Xmx2g -classpath /N/soft/rhel6/picard/picard-tools-1.107/ -jar \
    ...
    I = ./test_merge_sorted_NOdups_fixed.bam \
    O = ./test_merge_sorted_NOdups_fixed_marked.bam \
    M=test_merge_sorted_NOdups_fixed.metrics CREATE_INDEX=True VALIDATION_STRINGENCY=LENIENT
